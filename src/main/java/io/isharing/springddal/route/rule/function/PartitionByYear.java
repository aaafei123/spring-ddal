...
/**
 * 按年份列分区 ，每个自然年一个分片。每年的数据存入单独的数据库中。
 * 
 */
public class PartitionByYear extends AbstractPartitionAlgorithm implements RuleAlgorithm {
	 ...
	 * 如果没配置则按每一年的年份继续切分（即如开始时间为2010年1月，传入的时间为2018年12月，则分区为8）。
	 */
	...
	public static void main(String[] args) {
		String bd = "2015-03-01 13:33:12";
		String ed = "2017-12-31 23:59:59";
		PartitionByYear pm = new PartitionByYear();
		pm.setsBeginDate(bd);
		pm.setsEndDate(ed);
		pm.setDateFormat("yyyy-MM-dd HH:mm:ss");
		pm.init();
		int result = pm.calculate("2019-12-01 13:33:12");
