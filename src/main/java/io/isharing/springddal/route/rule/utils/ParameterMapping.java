...
public class ParameterMapping {
    ...
    public static void mapping(Object object, Map<String, ? extends Object> parameter) throws IllegalAccessException,
        ...
        for (int i = 0; i < pds.length; i++) {
            ...
            if (obj instanceof String) {
                ...
                value = createBean((BeanObjectEntityConfig) obj);
            } else if (obj instanceof BeanObjectEntityConfig[]) {
    ...
    public static Object createBean(BeanObjectEntityConfig config) throws IllegalAccessException, InvocationTargetException {
    ...
    public static boolean isPrimitiveType(Class<?> cls) {
        if (cls.equals(String.class) || cls.equals(Boolean.TYPE) || cls.equals(Byte.TYPE) || cls.equals(Short.TYPE)
                ...
                || cls.equals(BigDecimal.class) || cls.equals(BigInteger.class) || cls.equals(Date.class)
