...
public class SplitUtil {
    ...
    public static void main(String[] args) {
    	String dataNode = "rdna,rdnb,rdnc,rdnd,rdne,rdnf,rdng,rdn8";
    	String theDataNodes[] = SplitUtil.split(dataNode, ',', '$', '-');
    	ArrayList<String> dataNodes = new ArrayList<String>(theDataNodes.length);
		for (String dn : theDataNodes) {
			dataNodes.add(dn);
		}
		int i = 0;
		for(String dn : dataNodes){
			System.out.println(dataNodes.get(i) + ", "+ dn);
			i++;
		}
	}
}